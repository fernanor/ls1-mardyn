...
There are two programming frameworks for GPUs: \cuda{} and OpenCL. \TODO{add links to nvidia and opencl}
\TODO{reference to Orend} describes using OpenCL to parallelize MarDyn on a GPU. I am using \cuda{}.
...
For more information see \TODO{cuda manual and the best practices guide}.